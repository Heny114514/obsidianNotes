...
严格次极大位置：
$$\huge \dfrac{\d}{\d\alpha}\left(\dfrac{\sin\alpha}{\alpha}\right)^2=0$$
解得
$$ a\sin\theta=\pm1.43\lambda,\pm2.46\lambda,\pm3.47\lambda,\cdots\approx\pm(2k+1)\dfrac{\lambda}{2}\quad k=1,2,\cdots$$
使用时近似为相邻暗纹中心中点即可

次极大光强：
$$\huge \dfrac{I_\theta}{I_0}=\dfrac{\sin^2\alpha}{\alpha^2}=\dfrac{1}{(k+\dfrac{1}{2})^2\pi^2}=0.045,0.016,0.0083,\cdots$$
可见次极大光强**远小于**主极大光强
#### 条纹宽度
